  ...
  return <section ref={containerRef} className="relative min-h-screen pt-36 pb-20 overflow-hidden">
      ...
      scale
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          duration: 0.5,
          delay: 0.2
        }} className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">The unified platform that bridges your local machines with distributed AI datacenters. Run inference, manage models, and orchestrate agents—all from one control plane
.</motion.p>
          ...
          delay: 0.3
            ...
            <div className="flex border-b border-border">
              <button onClick={() => setActiveTab("mac")} className={`px-4 py-3 font-mono text-sm transition-colors ${activeTab === "mac" ? "text-foreground border-b-2 border-primary" : "text-muted-foreground hover:text-foreground"}`}>
                macOS / Linux
              </button>
              <button onClick={() => setActiveTab("windows")} className={`px-4 py-3 font-mono text-sm transition-colors ${activeTab === "windows" ? "text-foreground border-b-2 border-primary" : "text-muted-foreground hover:text-foreground"}`}>
                Windows
              </button>
            </div>
            ...
            <div className="p-4 flex items-center justify-between gap-4">
              ...
              <button onClick={handleCopy} className="text-muted-foreground hover:text-foreground transition-colors p-2">
