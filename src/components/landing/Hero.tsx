...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen pt-36 pb-20 overflow-hidden">
      ...
      {/* Gradient Orbs */}
      <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-primary/15 via-primary/5 to-transparent blur-3xl" />
      <div className="absolute bottom-1/4 left-1/3 w-[400px] h-[400px] rounded-full bg-gradient-to-tr from-cyan-500/10 to-transparent blur-3xl" />
