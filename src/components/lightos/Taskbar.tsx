import { Settings, Folder, TerminalSquare, LayoutDashboard, Globe, Info, Shield, Box, AppWindow, Square, Volume2, VolumeX, Bot, GitMerge, Building2, Coins, Cloud, Activity, Power, Network, Gauge, LineChart as LineChartIcon, Thermometer } from "lucide-react";
...
const APP_ICONS: Record<AppId, typeof Settings> = {
  ...
  photonic: Network,
  nce: Gauge,
  telemetry: LineChartIcon,
  thermalctl: Thermometer,
  route: AppWindow,
};
